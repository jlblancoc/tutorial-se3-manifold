...
%\multirow{2}{*}{\centering \includegraphics[width=0.15\textwidth]{./LOGO_UMA.eps}} & \centering \textbf{\textsc{\TRTitle}} & \centering \scriptsize{ Dpto. de Ingenierï¿½a de Sistemas y Automï¿½tica ETS Ingenierï¿½a Informï¿½tica}\\

...
\newcommand{\TRInfo}[6]{
    ...
    \end{center}
        ...
        \begin{flushleft}
        \includegraphics[width=0.3\textwidth]{./LOGO_UMA.pdf}
        \end{flushleft}
        \end{minipage}
        \hfill
...
%\multirow{2}{*}{\centering \includegraphics[width=0.15\textwidth]{./LOGO_UMA.pdf}} & \centering \textbf{\textsc{\TRTitle}} & \centering \scriptsize{ Dpto. de Ingenierï¿½a de Sistemas y Automï¿½tica ETS Ingenierï¿½a Informï¿½tica}\\

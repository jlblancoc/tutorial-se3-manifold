...
\begin{itemize}
 ...
 \item 9/May/2013: Added formulas for the Jacobian of the SO(3) logarithm map, in \S\ref{sect:eq:jacob_dLnROT_dROT}.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.70\textwidth]{fig_pose_composition.pdf}
...
\begin{figure}[h!]
\centering
\subfigure[The pose $\mathbf{p1}$]{\includegraphics[width=0.4\textwidth]{pose_comp_p1.pdf}}
\subfigure[The pose $\mathbf{p2}$]{\includegraphics[width=0.4\textwidth]{pose_comp_p2.pdf}} \\
\subfigure[Composition $\mathbf{p1} \oplus \mathbf{p2}$]{\includegraphics[width=0.6\textwidth]{pose_comp_p1p2.pdf}}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.50\textwidth]{quaternion.pdf}

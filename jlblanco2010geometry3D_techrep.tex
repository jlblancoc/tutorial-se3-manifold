...
\left(
  \begin{array}{ccccccc}
   ...
   0 & 0 & 0 & q_{r2} &-q_{x2} &-q_{y2} &-q_{z2}  \\
   0 & 0 & 0 & q_{x2} & q_{r2} & q_{z2} &-q_{y2}  \\
   0 & 0 & 0 & q_{y2} &-q_{z2} & q_{r2} & q_{x2}  \\
   0 & 0 & 0 & q_{z2} & q_{y2} &-q_{x2} & q_{r2}   
  \end{array}
\right) 
\\
\left. 
...
\left(
  \begin{array}{ccccccc}
     & & \left. \frac{\partial \mathbf{f_{qr}} (\mathbf{p_1}, [ x_2 ~ y_2 ~ z_2]^\top ) }{\partial \mathbf{p_2}} \right|_{3\times 7}  & &  \\ \hline
   0 & 0 & 0 & q_{r1} &-q_{x1} &-q_{y1} &-q_{z1}  \\
   0 & 0 & 0 & q_{x1} & q_{r1} &-q_{z1} & q_{y1}  \\
   0 & 0 & 0 & q_{y1} & q_{z1} & q_{r1} &-q_{x1}  \\
   0 & 0 & 0 & q_{z1} &-q_{y1} & q_{x1} & q_{r1}   
  \end{array}
\right) 
\\
\end{eqnarray}

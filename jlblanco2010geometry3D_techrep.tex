...
\TRInfo{6D poses as Euler angles, transformation matrices and quaternions: equivalences, compositions and uncertainty}
...
All those implementations have been thoroughly validated by means 
of several unit tests.
\end{abstract}

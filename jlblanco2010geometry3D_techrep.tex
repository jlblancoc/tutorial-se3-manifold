...
\noindent where $\mathbf{R}$ is the $3 \times 3$ SO(3) rotational part of the pose $\mathbf{\bar{p}_{12}}$ and the $vec(\cdot)$ operator is defined in \S\ref{sect:mat_deriv:ops}.

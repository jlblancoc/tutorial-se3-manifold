...
{Jose-Luis Blanco\\ \begin{small} \texttt{joseluisblancoc@gmail.com} \\ \texttt{http://sites.google.com/site/jlblancosite/} \end{small} }
...
\label{eq:rodrigues_ln}
 \ln(\mathbf{R}) &=& \frac{1}{2\sin \theta} \left( \mathbf{R} - \mathbf{R}^\top
\right)
\nonumber \\

...
\begin{itemize}
 \item Version 2: Added more Jacobians (\S\ref{sect:jacob_eDp}, \S\ref{sect:jacob_eDp_inv}), the Appendix \ref{ch:apx:cv} and approximation in \S\ref{eq:jacob_A_e_D_p}. (12/Sep/2010)
